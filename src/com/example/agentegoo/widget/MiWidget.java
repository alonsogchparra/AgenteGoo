package com.example.agentegoo.widget;
...
//		String mensaje = prefs.getString("msg_" + widgetId, "Hora actual:");
		...
		controles.setOnClickPendingIntent(R.id.FrmWidget, pendingIntent);

		Intent intent2 = new Intent(context, Test.class);
		PendingIntent pendingIntent2 = PendingIntent.getActivity(context,
				widgetId, intent2, PendingIntent.FLAG_UPDATE_CURRENT);

		controles.setOnClickPendingIntent(R.id.imageButton1, pendingIntent2);
